...
function SliderRow({
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      ...
      />
      <span style={{ color: "#e0e8ff", minWidth: 52, textAlign: "right" }}>
        {display}
      </span>
    </div>
  );
...
export default function DungeonSettingsModal({ onClose }: Props) {
  ...
  function set<K extends keyof RendererSettings>(
    key: K,
